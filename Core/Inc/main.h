...
#define CW_IN_GPIO_Port GPIOC
#define CCW_IN_Pin GPIO_PIN_3
#define CCW_IN_GPIO_Port GPIOC
...
#define SPEED_HIGH_IN_GPIO_Port GPIOC
#define MODE_IN_Pin GPIO_PIN_11
#define MODE_IN_GPIO_Port GPIOC
#define SPEED_LOW_IN_Pin GPIO_PIN_12
#define SPEED_LOW_IN_GPIO_Port GPIOC
